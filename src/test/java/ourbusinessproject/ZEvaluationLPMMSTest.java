...
public class ZEvaluationLPMMSTest {
    ...
    /* **
     * Question 3.4 ) 
     *  Ce test réussit si on évite un conflit d'utilisation d'un objet,
     *  On utilise un projet existant que l'on modifie (changement de titre) en récupérant 
     *  le bon ID du projet pour simuler la modification.
     *  On modifie ensuite le projet avec le entityManager et on sauvegarde.
     *  Une exception est retournée si il y a un conflit qui est survenu. 
     * **/
